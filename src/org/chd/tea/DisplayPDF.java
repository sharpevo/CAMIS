 ...
 */
public class DisplayPDF implements BinaryExportView
{
    ...
    protected void initTable() throws BadElementException
    {
        ...
        /*tablePDF.setDefaultHorizontalAlignment(Element.ALIGN_CENTER);*/
        tablePDF.setCellsFitPage(true);
        tablePDF.setWidth(100);
        tablePDF.setAutoFillEmptyCells(true);
        tablePDF.setAlignment(2);
        ...
        smallFont = FontFactory.getFont("STSong-Light","UniGB-UCS2-H", 7, Font.NORMAL); 
     ...
     */
    protected void generatePDFTable() throws JspException, BadElementException, UnsupportedEncodingException
    {
        if (this.header)
        {
            generateHeaders();
     ...
     * @throws UnsupportedEncodingException 
     */
    protected void generateRows() throws JspException, BadElementException, UnsupportedEncodingException
    {
        ...
        while (rowIterator.hasNext())
        {
            ...
            while (columnIterator.hasNext())
            {
                ...
                //Cell cell = getCell(new String(ObjectUtils.toString(value).getBytes("GBK"),"ISO-8859-1"));
