...
public class TablePY implements Serializable {
	...
	public TablePY(Integer subjectId, String teacherId, float achievement, float argumentation, float translating, float design, float designSpecification, float innovation, String tag, String comment, Date dater) {
		super();
