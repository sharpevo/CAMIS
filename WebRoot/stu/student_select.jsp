...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<%@include file="top.jspf"%>
		...
		<br />
		<form action="/stu/ShowSubjectBySort.do" method="post">
		...
		<table cellspacing="2" cellpadding="0" border="0" width="80%"
			...
			<%
...

				{
					...
					out.println("<tr><td><a href='/stu/ShowSubjectDetail.do?subjectId=" + subject.getSubjectId() +"'>" + subject.getSubjectId() + "</a></td>");
					out.println("<td>" + subject.getSubject() + "</td>");
					out.println("<td><a href='/stu/ShowTeacherInfo.do?teacherId="+subject.getTeacherAId()+"'>" + subject.getTeacherAId() + "</a></td>");	
					out.println("<td><a href='/stu/SelectSubject.do?subjectId="+subject.getSubjectId()+"'>"+"选 中</a></td></tr>");
				}
			%>
		</table>
		<br />
		<form action="/stu/StuSelectSubject.do" method="post">
		<table cellspacing="0" cellpadding="0" border="0" width="80%"
			align="center">
			<tr align="center">
				<td>
					<a href="/stu/StuSelectSubject.do?nowPage=<%=prevpage %>">上一页</a>&nbsp;&nbsp;<a href="/stu/StuSelectSubject.do?nowPage=<%=nextpage %>">下一页</a>当前第<%=nowPage%>页&nbsp;&nbsp;<a href="/stu/StuSelectSubject.do?nowPage=<%=totalpage %>">最后一页</a>&nbsp;&nbsp;第
					<select name="nowPage">
						<%
